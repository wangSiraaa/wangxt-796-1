    ...
    <div className="min-h-screen bg-gradient-to-br from-museum-50 via-white to-cyan-50">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900 font-serif">游客自助服务</h1>
                <p className="text-sm text-gray-500">博物馆讲解器租借查询</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <p className="text-sm text-gray-500">可租借设备</p>
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <p className="text-sm text-gray-500">租借中</p>
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-2xl font-bold text-amber-600">{stats.lowBattery}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          <h2 className="text-xl font-bold text-gray-900 font-serif">可租借设备</h2>
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-museum-500/20 focus:border-museum-500 w-full sm:w-48"
              />
            </div>
        ...
        {rentableDevices.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-2xl border border-gray-100">
            ...
            <p className="text-gray-500">暂无符合条件的可租借设备</p>
          </div>
        ) : (
